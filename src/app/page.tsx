...
export default function HomePage() {
  ...
  const [messages, setMessages] = useState<MessageItem[]>([
    {
      ...
      type: "bot",
      isIntro: true,
      text: "Xin chào! Hãy nhập số thứ tự hoặc một cụm từ trong họ tên học sinh để tra cứu.",
    },
  ]);
  ...
  const executeSearch = async (searchQuery: string) => {
    ...
    try {
      ...
      // Trường hợp 2: Có đúng 1 kết quả
  ...
  return (
    <div className="max-w-[1320px] mx-auto p-4 md:p-6 min-h-screen grid grid-cols-1 lg:grid-cols-[300px_minmax(0,1fr)] gap-6">
      {/* AUTH MODAL */}
